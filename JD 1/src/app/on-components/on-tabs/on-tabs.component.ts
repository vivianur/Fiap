...
*      <p>
*        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsa corrupti repellendus  non, consequatur modi provident itaque! Fugiat suscipit, ut eveniet esse alias natusquo amet optio maiores quos sapiente. Qui?
*      </p>
*      <p>
*        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsa corrupti repellendus non, consequatur modi provident itaque! Fugiat suscipit, ut eveniet esse alias natus  quo amet optio maiores quos sapiente. Qui?
*      </p>
...
export class OnTabsComponent implements AfterViewInit, AfterContentInit {
  ...
  changeTitlesToDataTitles() {
    this.tabs.map((tab) => {
      tab.setAttribute('data-title', tab.getAttribute('title'))
