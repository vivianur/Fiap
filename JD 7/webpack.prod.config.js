...
const genDirNodeModules = path.join(process.cwd(), 'src');
...
module.exports = {
  ...
  "module": {
    "rules": [
      ...
      {
        test: /(on-image|on-background)-([\w\s\-\_]+)\.(eot|svg|cur)/,
        loader: "file-loader?name=./assets/public/[name].[hash:20].[ext]"
      },
      {
        test: /(on-private)-([\w\s\-\_]+)\.(eot|svg|cur)/,
        loader: "file-loader?name=./assets/private/[name].[hash:20].[ext]"
      },
      {
        test: /(on-image|on-background)-([\w\s\-\_]+)\.(jpg|png|gif)/,
        loader:
          "url-loader?name=./assets/public/[name].[hash:20].[ext]&limit=10000"
      },
      {
        test: /(on-private)-([\w\s\-\_]+)\.(jpg|png|gif)/,
        loader:
          "url-loader?name=./assets/private/[name].[hash:20].[ext]&limit=10000"
      },
      {
        test: /\.(otf|ttf|woff|woff2)$/,
        loader: "url-loader?name=./assets/public/fonts/[name].[ext]&limit=10000"
      },
      {
        "test": /\.js$/,
        "use": [
  ...
  "plugins": [
    ...
    new ScriptsWebpackPlugin({
      ...
      "scripts": [
        ...
        `${nodeModules}/hammerjs/hammer.min.js`,
        `${nodeModules}/clipboard/dist/clipboard.min.js`,
